...
use \Gudtech\RetailOps\Model\ResourceModel\Collection\RoRicsLinkUpc\CollectionFactory;
use \Gudtech\RetailOps\Api\Data\RetailOpsRicsLinkByUpcInterface as RoRiLink;
...
class RoRicsLinkUpcRepository implements RetailOpsRicsLinkByUpcRepositoryInterface
{
    ...
    public function __construct(
        ...
        \Gudtech\RetailOps\Model\ResourceModel\RoRicsLinkUpc $resource,
        \Gudtech\RetailOps\Model\RoRicsLinkUpcFactory $roRicsLinkFactory,
    ...
    public function getAllROUpcsByUpcs($upcs)
    {
        $collection = $this->collectionFactory->create();
        /**
         * @var \Gudtech\RetailOps\Model\ResourceModel\Collection\RoRicsLinkUpc\Collection $collection
         */
