...
class Inventory
{
    ...
    /**
     * @var \Gudtech\RetailOps\Api\InventoryHistoryInterface
     */
    protected $_inventoryHistoryRepository;

    /**
     * @var LoggerInterface|\Gudtech\RetailOps\Model\Logger\Monolog
     */
    protected $logger;

    /**
     * @var \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory|\Gudtech\RetailOps\Model\Product\CollectionFactory
     */
    ...
    /**
     * @var \Gudtech\RetailOps\Api\Data\InventoryHistoryInterfaceFactory_InventoryHistory
     */
    ...
    public function __construct(
        ...
        \Gudtech\RetailOps\Model\Product\CollectionFactory $productCollectionFactory,
        ...
        \Gudtech\RetailOps\Api\Data\InventoryHistoryInterfaceFactory $InventoryHistory,
        \Gudtech\RetailOps\Api\InventoryHistoryInterface $inventoryHistoryRepository,
        \Magento\Framework\ObjectManagerInterface $objectManager,
        \Magento\Catalog\Model\ProductFactory $productFactory,
        \Magento\Framework\View\Element\Context $context,
        \Gudtech\RetailOps\Service\CalculateInventory $calculateInventory
    ) {
        $this->logger = $logger;
