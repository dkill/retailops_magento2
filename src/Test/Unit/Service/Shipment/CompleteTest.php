...
namespace Gudtech\RetailOps\Test\Unit\Service\Shipment;
...
class CompleteTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Gudtech\RetailOps\Service\Shipment\Complete
     */
    protected $model;
    ...
    public function setUp()
    {
        ...
        $this->model = $this->objectManagerHelper->getObject(
            \Gudtech\RetailOps\Service\Shipment\Complete::class,
            [
