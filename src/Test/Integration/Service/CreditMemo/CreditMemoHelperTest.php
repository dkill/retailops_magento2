...
namespace Gudtech\RetailOps\Test\Integration\Service\CreditMemo;
...
class CreditMemoHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateNotCreateMemo()
    {
        ...
        /**
         * @var \Gudtech\RetailOps\Service\CreditMemo\CreditMemoHelper
         */
        $creditMemoHelper = $objectManager->get(\Gudtech\RetailOps\Service\CreditMemo\CreditMemoHelper::class);
