...
namespace Gudtech\RetailOps\Test\Integration\Model\Map;
...
class OrderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPrepareOrder()
    {
        ...
        /**
         * @var \Gudtech\RetailOps\Model\Api\Map\Order $roOrder
         */
        $roOrder = $objectManager->get(\Gudtech\RetailOps\Model\Api\Map\Order::class);
