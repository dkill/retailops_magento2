...
class CompleteTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCompleteOrder()
    {
        ...
        $orderComplete = $objectManager->create(\Gudtech\RetailOps\Model\Api\Order\Complete::class);
        /**
         * @var \Gudtech\RetailOps\Model\Api\Order\Complete $orderComplete
         */
    ...
    public function testCompleteOrderAfterShipment()
    {
        $this->setPostDataAllShipment();
        $objectManager = Bootstrap::getObjectManager();
        $orderSubmit = $objectManager->create(\Gudtech\RetailOps\Model\Shipment\ShipmentSubmit::class);
        /**
         * @var \Gudtech\RetailOps\Model\Shipment\ShipmentSubmit $orderSubmit
         */
